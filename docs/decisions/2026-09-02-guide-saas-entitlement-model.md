...
> 關聯：#48、#118、09-FEATURE-STORE、13-BUSINESS-MODES、19-GUIDE-PRODUCT-EXPERIENCE
...
免費／試用的限制可放在「新接多少有效旅客／有效訂單／發布行程／使用天數」等成長指標，但額度到期不能把已成立訂單、退款、安全通知或歷史資料鎖死。
