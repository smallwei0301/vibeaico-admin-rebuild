<!--
Compact authoring template for scripts/agents/pr-metadata-profile.mjs.
Do NOT paste this compact form directly into a PR. Materialize first, then use the generated body.
-->
...
<!-- PRODUCT_TERRA_BUILD only: keep these explicit because they depend on the real Product slice. -->
