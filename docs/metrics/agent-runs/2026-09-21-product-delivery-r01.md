# Delivery Outcome：2026-09-21-product-delivery-r01
...
- 內部加權 usage：28（比較尺，不是官方 token）
- 每件真正出貨 usage：資料不足

## 可觀測衍生指標

- observed task events：4
- cycle time：588.4 分鐘（startedAt → endedAt）
- Luna 採用率：100%（直接由 modelUsage.tasks 衍生）
- closure conversion：0%
- verified claim evidence coverage：0%
