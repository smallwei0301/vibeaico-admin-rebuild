...
export const MOCK_TRIP_DEPARTURES: TripDeparture[] = [
  { id: 'dp_1', tripId: 'tp_1', planId: 'pl_1', planName: '標準團（共乘）', departsOn: '2026-08-23', startTime: '09:00', capacity: 8, seatsBooked: 8, status: 'OPEN', note: '', primaryStaffId: 's_1', primaryStaffName: '阿海', assistantStaffIds: [], assistantStaffNames: [], formationStatus: 'FORMED', minToDepartSnapshot: 4, formedAt: '2026-08-18T02:00:00Z', formedBy: 'SYSTEM', formedParticipants: 6 },
  { id: 'dp_2', tripId: 'tp_1', planId: 'pl_1', planName: '標準團（共乘）', departsOn: '2026-08-24', startTime: '09:00', capacity: 8, seatsBooked: 5, status: 'OPEN', note: '', primaryStaffId: 's_1', primaryStaffName: '阿海', assistantStaffIds: ['s_4'], assistantStaffNames: ['Kai'], formationStatus: 'FORMED', minToDepartSnapshot: 4, formedAt: '2026-08-19T01:30:00Z', formedBy: 'SYSTEM', formedParticipants: 4 },
  { id: 'dp_3', tripId: 'tp_1', planId: 'pl_1', planName: '標準團（共乘）', departsOn: '2026-08-25', startTime: '09:00', capacity: 8, seatsBooked: 2, status: 'OPEN', note: '船班已確認', primaryStaffId: 's_2', primaryStaffName: '小雨', assistantStaffIds: [], assistantStaffNames: [], formationStatus: 'COLLECTING', minToDepartSnapshot: 4, formationDeadlineAt: '2026-08-18T15:59:00Z' },
  { id: 'dp_4', tripId: 'tp_1', planId: 'pl_1', planName: '標準團（共乘）', departsOn: '2026-08-26', startTime: '13:30', capacity: 8, seatsBooked: 0, status: 'OPEN', note: '', primaryStaffId: 's_4', primaryStaffName: 'Kai', assistantStaffIds: [], assistantStaffNames: [], formationStatus: 'REVIEW_REQUIRED', minToDepartSnapshot: 4, formationDeadlineAt: '2026-08-19T15:59:00Z' },
  { id: 'dp_5', tripId: 'tp_1', planId: 'pl_3', planName: '攝影特別團', departsOn: '2026-08-27', startTime: '06:00', capacity: 6, seatsBooked: 1, status: 'CLOSED', note: '方案審核中暫停銷售', primaryStaffId: 's_4', primaryStaffName: 'Kai', assistantStaffIds: ['s_1'], assistantStaffNames: ['阿海'], formationStatus: 'COLLECTING', minToDepartSnapshot: 2 },
  { id: 'dp_6', tripId: 'tp_1', planId: 'pl_1', planName: '標準團（共乘）', departsOn: '2026-08-28', startTime: '09:00', capacity: 8, seatsBooked: 0, status: 'CANCELLED', note: '颱風假', primaryStaffId: 's_1', primaryStaffName: '阿海', assistantStaffIds: [], assistantStaffNames: [], formationStatus: 'FAILED', minToDepartSnapshot: 4 },
  { id: 'dp_7', tripId: 'tp_2', planId: 'pl_4', planName: '小團導覽（4 人成行）', departsOn: '2026-08-23', startTime: '16:30', capacity: 10, seatsBooked: 6, status: 'OPEN', note: '', primaryStaffId: 's_2', primaryStaffName: '小雨', assistantStaffIds: [], assistantStaffNames: [], formationStatus: 'FORMED', minToDepartSnapshot: 4, formedAt: '2026-08-16T03:00:00Z', formedBy: 'GUIDE_OVERRIDE', formedParticipants: 6 },
  { id: 'dp_8', tripId: 'tp_2', planId: 'pl_4', planName: '小團導覽（4 人成行）', departsOn: '2026-08-30', startTime: '16:30', capacity: 10, seatsBooked: 3, status: 'OPEN', note: '', primaryStaffId: 's_2', primaryStaffName: '小雨', assistantStaffIds: ['s_1'], assistantStaffNames: ['阿海'], formationStatus: 'AT_RISK', minToDepartSnapshot: 4, formedAt: '2026-08-20T05:00:00Z', formedBy: 'SYSTEM', formedParticipants: 5 },
  { id: 'dp_9', tripId: 'tp_3', planId: 'pl_6', planName: '一日溯溪體驗', departsOn: '2026-08-24', startTime: '08:00', capacity: 12, seatsBooked: 9, status: 'OPEN', note: '', primaryStaffId: 's_2', primaryStaffName: '小雨', assistantStaffIds: [], assistantStaffNames: [], formationStatus: 'FORMED', minToDepartSnapshot: 6, formedAt: '2026-08-17T06:00:00Z', formedBy: 'SYSTEM', formedParticipants: 9 },
  { id: 'dp_10', tripId: 'tp_3', planId: 'pl_6', planName: '一日溯溪體驗', departsOn: '2026-08-31', startTime: '08:00', capacity: 12, seatsBooked: 0, status: 'OPEN', note: '', formationStatus: 'COLLECTING', minToDepartSnapshot: 6 },
];
