...
export const bookingsPage = {
  ...
  addonModal: {
    ...
    staffSame: '同本預約的人員',
    noPersonalCredit: '不計入任何個人業績',
    notify: '通知顧客消費明細',
    footnote:
      '佔時間的加購會延長預約結束時間；耗材類選「不佔時間」只加金額。通知結果會在儲存後如實顯示；加錯了可在詳情逐項移除回沖。',
    submit: '加入',
    submitting: '處理中...',
  },
  ...
  adjustPriceModal: {
    ...
    bullets: [
      ...
      '• 若是「多做了項目/多花了時間」請改用「加購」——才會延長時段並留下 C+ 歸屬快照；勾選通知後會如實顯示 LINE／未綁定／額度或失敗結果',
    ],
    label: '金額',
  ...
  confirmMessages: {
    ...
    removeAddon:
      '確定移除此加購項目嗎？金額與時長會在同一筆交易同步扣回。已送出的 LINE 訊息不會自動撤回。',
  },
  ...
  messages: {
    ...
    addonAddedNoLine: '加購已加入；此顧客未綁 LINE，請自行告知消費明細',
    addonNotificationOutcome: {
      NONE: '加購已加入（未通知顧客）', LINE: '加購已加入，已送出 LINE 消費明細',
      NO_LINE: '加購已加入；顧客未綁定 LINE，未送出明細',
