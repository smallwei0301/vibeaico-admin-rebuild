...
export const keywordRepliesPage = {
  ...
  form: {
    ...
    imageUploading: '圖片上傳中…尚未儲存關鍵字回覆。',
    imageUploaded: '圖片已上傳，儲存關鍵字回覆後才會對顧客生效。',
    imageSavePending: '圖片仍在上傳中，完成後才能儲存。',
    imageRemove: '移除',
    linkUrl: '附加連結按鈕（選填）',
  ...
  messages: {
    ...
    imageUploadFailed: '圖片上傳失敗，未建立任何圖片回覆。',
    imageRequiresRealMode: '目前為展示模式，無法進行實際圖片上傳。請切換至實際資料模式後再試。',
