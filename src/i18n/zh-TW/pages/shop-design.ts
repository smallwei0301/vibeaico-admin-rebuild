...
export const shopDesignPage = {
  ...
  banner: {
    ...
    videoTitle: '橫幅影片（選填）',
    videoUpload: '上傳影片',
    videoUploading: '影片上傳中…',
    videoRemove: '移除影片',
    videoRemoving: '移除中…',
    videoHelpLead: '支援 MP4 / WebM，最大 50MB（約可放 30 秒~1 分鐘）。影片顯示在公開頁橫幅',
  ...
  messages: {
    ...
    videoUploaded: '影片已上傳',
    videoRemoved: '影片已移除',
    videoUploadFailedPrefix: '影片上傳失敗：',
    videoRemoveFailedPrefix: '影片刪除失敗：',
    videoFormat: '影片只支援 MP4 / WebM 格式',
    videoTooLarge: '影片大小不可超過 50MB（手機拍攝請選較短或較低畫質）',
    lineLinkFilled: '已填入 LINE 連結，請確認後儲存',
    lineLinkFailed: '取得 LINE 連結失敗',
    lineLinkMissing: '無法取得 LINE 連結',
    presignFailed: '取得上傳網址失敗',
    storageUploadFailedPrefix: '上傳到儲存空間失敗（HTTP ',
    storageUploadFailedSuffix: '），請稍後再試',
