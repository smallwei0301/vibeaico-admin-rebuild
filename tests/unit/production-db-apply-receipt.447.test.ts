...
import { advanceApplyReceipt, assertApplyReceiptAdmitted, createProductionDbApplyReceipt } from '../../scripts/agents/production-db-apply-receipt.mjs';
...
describe('Production DB single-use apply receipt #447',()=>{
  it('admits one fresh exact-plan receipt for the pinned Production project',()=>{
  ...
  it('blocks receipt replay after consumption or uncertainty',()=>{
  ...
  it('blocks wrong project, stale receipt and plan mismatch',()=>{
