...
describe('#396 已提交的正式資料', () => {
  ...
  it('分類統計符合已查證的事實：50 EXACT、6 ALIAS、7 NOT_APPLIED、1 LEDGER_ONLY', () => {
    ...
    // 與本候選的 0113_issue_23_promotion_page_view_events，所以 NOT_APPLIED 是
...
describe('#396 NOT_APPLIED 的兩種狀態必須用列舉講清楚', () => {
  ...
  it('已提交的正式對照表：每一筆 NOT_APPLIED 都有合法的 notAppliedReason', () => {
    ...
    // 目前為 6 筆（0105、0109、0110、0111、0112 與本候選
    // 0113_issue_23_promotion_page_view_events，皆 PENDING_APPLY；0107／0108
