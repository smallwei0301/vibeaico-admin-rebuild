...
describe('#396 已提交的正式資料', () => {
  ...
  it('分類統計符合已查證的事實：50 EXACT、6 ALIAS、3 NOT_APPLIED、1 LEDGER_ONLY', () => {
    ...
    // 再次重新擷取本快照（49 → 50）。尚未套用的是 0105、0109、0110 與本候選的
    // 0111，所以 NOT_APPLIED 是 4。四者依 AGENTS.md 的規則，在合併進 main 之前
    // 都不是任何環境的套用授權。
