...
describe('#396 已提交的正式資料', () => {
  ...
  // 本候選的 0116_issue_18_owner_notify，正式庫快照維持 57 筆實際
  ...
  it('分類統計符合已查證的事實：50 EXACT、6 ALIAS、9 NOT_APPLIED、1 LEDGER_ONLY', () => {
    ...
    // 0113、0114 與本候選的 0115_issue_21_external_calendars，所以 NOT_APPLIED
