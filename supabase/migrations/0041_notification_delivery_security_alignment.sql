-- 0041 — #40 forward-only notification security alignment
--
-- TEST has already applied 0038, 0038a, and 0040. This migration is the
-- only place for subsequent notification schema, trigger, and RPC changes.
...
-- 0040 replaced these trigger functions after the v2 empty-search-path
