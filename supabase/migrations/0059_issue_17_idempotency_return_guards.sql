-- Issue #17 forward repair after 0058.
--
-- RETURN NEXT appends a result row but does not terminate a PL/pgSQL function.
-- Replay branches must therefore return explicitly, or a safe replay can fall
-- through into the booking mutation a second time.
--
