...
const ROLE = /^(?:[A-Za-z_][A-Za-z0-9_]*|public)$/;
...
function normalizeRole(value, label) {
  // PostgreSQL preserves case for quoted role names. Do not collapse two
  // distinct role identities before comparing ACL evidence. Do not trim
  // either: unsupported quoted names containing whitespace must fail closed.
